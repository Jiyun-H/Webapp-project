...
const GermanRestaurants = () => {
  ...
  useEffect(() => {
    const fetchRestaurants = async () => {
      try {
        const response = await axios.get('http://localhost:5001/api/restaurants/type/german', {
          params: { ...sortOptions }
         });
...
export default GermanRestaurants;
